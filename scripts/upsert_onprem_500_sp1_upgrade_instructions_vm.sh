...
SCOPE="https://experienceleague.adobe.com/en/docs/experience-manager-guides/using/release-info/release-notes/on-prem-release-notes/500-sp1-release"
SLUG="upgrade-instructions-5-0-0-sp1"
STATE_DIR="tmp/rag-onprem-500-sp1-$SLUG"
RAW_OUTPUT="tmp/onprem-500-sp1-$SLUG-behavior-chunks.json"
ENRICHED_OUTPUT="tmp/onprem-500-sp1-$SLUG-enriched-behavior-chunks.json"
