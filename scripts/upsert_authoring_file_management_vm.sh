...
SCOPE="https://experienceleague.adobe.com/en/docs/experience-manager-guides/using/user-guide/appendix/manage-content"
SLUG="authoring-file-management"
SOURCE_URL="$SCOPE/$SLUG"
STATE_DIR="tmp/rag-authoring-file-management"
RAW_OUTPUT="tmp/rag-authoring-file-management-behavior-chunks.json"
ENRICHED_OUTPUT="tmp/rag-authoring-file-management-enriched-behavior-chunks.json"
