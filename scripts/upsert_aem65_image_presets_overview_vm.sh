...
SCOPE="https://experienceleague.adobe.com/en/docs/experience-manager-65/content/assets/dynamic"
SOURCE_URL="$SCOPE/image-presets"
STATE_DIR="tmp/rag-aem65-image-presets-overview"
OUTPUT="tmp/rag-aem65-image-presets-overview-chunks.json"
