cat > ~/aem-guides-dataset-studio/backend/ingest_editor_additional_features.py << 'PYEOF'
...
PYEOF
cd ~/aem-guides-dataset-studio/backend && python3 ingest_editor_additional_features.py
