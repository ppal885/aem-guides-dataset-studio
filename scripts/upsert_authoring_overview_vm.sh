...
SCOPE="https://experienceleague.adobe.com/en/docs/experience-manager-guides/using/user-guide/author-content"
SLUG="authoring-content"
SOURCE_URL="$SCOPE/$SLUG"
STATE_DIR="tmp/rag-authoring-overview"
RAW_OUTPUT="tmp/rag-authoring-overview-behavior-chunks.json"
ENRICHED_OUTPUT="tmp/rag-authoring-overview-enriched-behavior-chunks.json"
