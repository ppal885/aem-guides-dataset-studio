...
SCOPE="https://experienceleague.adobe.com/en/docs/experience-manager-guides/using/user-guide/author-content/work-with-editor"
SLUG="web-editor-launch-editor"
SOURCE_URL="$SCOPE/$SLUG"
STATE_DIR="tmp/rag-launch-editor"
RAW_OUTPUT="tmp/rag-launch-editor-behavior-chunks.json"
ENRICHED_OUTPUT="tmp/rag-launch-editor-enriched-behavior-chunks.json"
