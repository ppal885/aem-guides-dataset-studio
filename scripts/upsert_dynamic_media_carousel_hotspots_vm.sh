...
SCOPE="https://experienceleague.adobe.com/en/docs/dynamic-media-developer-resources/library/viewers-for-aem-assets-only/carousel/customizing-carousel"
SOURCE_URL="$SCOPE/r-html5-aem-carousel-customize-hotspots-imagemaps"
STATE_DIR="tmp/dmc"
OUTPUT="tmp/dmc-chunks.json"
