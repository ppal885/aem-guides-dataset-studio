    ...
    *,
    ...
    if _looks_like_publish_filtering_question(question):
        lines = [
            ...
            "- Mark normal topic content with profiling attributes such as `@audience`, `@props`, or `@otherprops`.",
            ...
            "Full topic example:",
            "```xml",
            "<topic id=\"publish-filtering-example\">",
            "  <title>Release notes</title>",
            "  <body>",
            "    <p>This paragraph publishes normally.</p>",
            "    <p otherprops=\"draft-only\">Internal review note.</p>",
            "    <draft-comment>",
            "      <p>Remove this reviewer note from final output.</p>",
            "    </draft-comment>",
            "  </body>",
            "</topic>",
            "```",
            "",
            "Matching `.ditaval` example:",
            "```xml",
            "<val>",
            "  <prop action=\"exclude\" att=\"otherprops\" val=\"draft-only\"/>",
            "</val>",
            "```",
            "",
            "In AEM Guides, apply that `.ditaval` or condition preset in the Output Preset used for publishing.",
            "",
