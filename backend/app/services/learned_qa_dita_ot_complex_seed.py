...
_TOPICS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "terms": ["DITAVAL", "ditavalref", "branch filtering", "resourceprefix", "resourcesuffix", "keyscopeprefix"],
    ...
    },
    {
        ...
        "terms": ["preprocess", "temp", "job.xml", "keyref", "conref", "mapref"],
    ...
    },
    {
        ...
        "terms": ["keyref", "keydef", "keyscope", "root map", "preprocess"],
    ...
    },
    {
        ...
        "terms": ["conref", "conkeyref", "conrefend", "reuse", "preprocess"],
    ...
    },
    {
        ...
        "terms": ["chunk", "copy-to", "href", "xref", "generated output"],
    ...
    },
    {
        ...
        "terms": ["CALS", "morerows", "namest", "nameend", "colspec", "PDF"],
    ...
    },
    {
        ...
        "terms": ["image", "svg", "scale", "scalefit", "width", "height", "alt"],
    ...
    },
    {
        ...
        "terms": ["URI", "path", "spaces", "case-sensitive", "Windows", "Linux"],
