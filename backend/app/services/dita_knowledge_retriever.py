...
DITA_BOOST_TERMS = {
    ...
    "index-base": 1.8,
    "itemgroup": 1.7,
    "no-topic-nesting": 1.7,
    "state": 1.2,
    "unknown": 1.6,
    "required-cleanup": 1.7,
    "collection": 1.5,
    "linking": 1.5,
    "hierarchy": 1.5,
    "note": 1.5,
    ...
    # Attribute groups
    "id attributes": 1.5,
    "metadata attributes": 1.5,
    "localization attributes": 1.5,
    "debug attributes": 1.5,
    "architectural attributes": 1.5,
    "common map attributes": 1.5,
    "cals table attributes": 1.5,
    "display attributes": 1.5,
    "date attributes": 1.5,
    "link relationship attributes": 1.5,
    "common attributes": 1.5,
    "simpletable attributes": 1.5,
    "xml:lang": 1.5,
    "xtrf": 1.3,
    "xtrc": 1.3,
    "class": 1.2,
...
DITA_ELEMENT_NAMES = [
    ...
    "link", "linklist", "linkinfo", "relatedl",
    "foreign", "data", "data-about", "boolean", "index-base", "itemgroup", "no-topic-nesting",
    "state", "unknown", "required-cleanup", "indexterm",
    "note", "sectiondiv", "bodydiv", "p", "ul", "ol", "li", "dl", "dlentry", "dt", "dd", "dlhead", "dthd", "ddhd",
    "prereq", "context", "result", "cmd", "info", "stepresult",
    "subjectScheme", "subjectdef", "schemeref", "ditaval", "ditaval-elements", "val", "prop", "revprop",
    "startflag", "endflag", "alt-text", "style-conflict", "chunk",
    "audience", "platform", "otherprops", "properties", "related-links",
    "id attributes", "metadata attributes", "localization attributes", "xml:lang", "translate", "dir",
    "debug attributes", "architectural attributes", "common map attributes", "cals table attributes",
    "display attributes", "date attributes", "link relationship attributes", "common attributes", "simpletable attributes",
    "xtrf", "xtrc", "class", "domains", "processing-role", "collection-type", "linking", "print",
    "search", "locktitle", "colsep", "rowsep", "rowheader", "align", "valign",
    "expanse", "frame", "scale", "expiry", "golive", "role", "otherrole", "base", "status",
    "keycol", "relcolwidth", "refcols",
]
