...
SCRIPT_PATH = (
    ...
    / "scripts"
    / "upsert_launch_editor_vm.sh"
)
SOURCE_URL = (
    "https://experienceleague.adobe.com/en/docs/experience-manager-guides/using/"
    "user-guide/author-content/work-with-editor/web-editor-launch-editor"
)


def test_launch_editor_script_targets_exact_official_page():
    script = SCRIPT_PATH.read_text(encoding="utf-8")

    assert 'SLUG="web-editor-launch-editor"' in script
...
def test_launch_editor_script_builds_raw_and_enriched_chunks():
    script = SCRIPT_PATH.read_text(encoding="utf-8")
