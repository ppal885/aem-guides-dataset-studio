...
SCRIPT_PATH = (
    ...
    / "scripts"
    / "upsert_authoring_overview_vm.sh"
)
SOURCE_URL = (
    "https://experienceleague.adobe.com/en/docs/experience-manager-guides/using/"
    "user-guide/author-content/authoring-content"
)


def test_authoring_overview_script_targets_exact_official_page():
    script = SCRIPT_PATH.read_text(encoding="utf-8")

    assert 'SLUG="authoring-content"' in script
...
def test_authoring_overview_script_builds_raw_and_enriched_chunks():
    script = SCRIPT_PATH.read_text(encoding="utf-8")
