...
SCRIPT_PATH = (
    ...
    / "scripts"
    / "upsert_repository_home_view_vm.sh"
)
SOURCE_URL = (
    "https://experienceleague.adobe.com/en/docs/experience-manager-guides/using/"
    "user-guide/home-page/home-page-repository-view"
)


def test_repository_home_view_script_targets_exact_official_page():
    script = SCRIPT_PATH.read_text(encoding="utf-8")

    assert 'SLUG="home-page-repository-view"' in script
...
def test_repository_home_view_script_builds_raw_and_enriched_chunks():
    script = SCRIPT_PATH.read_text(encoding="utf-8")
