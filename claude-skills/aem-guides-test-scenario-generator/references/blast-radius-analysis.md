...
Use this reference for every JIRA-driven AEM Guides test plan before selecting or generating scenarios. Blast-radius analysis remains a blocking gate, but the goal is now bug discovery and regression prevention.
